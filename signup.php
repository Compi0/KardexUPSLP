...
<div class='bg-top'>
  ...
  <div class='bg'>
    <div class='bg-inner'></div>
			...
			<form action="csv.html" method="post">
			<button class='btn block-cube block-cube-hover' type='button'>
			<div class='bg-top'>
				<div class='bg-inner'></div>
			</div>
			...
			<div class='text'>
				<input type="submit" value="Importar datos" class="btn block-cube">
			</div>
			</button>
			</form>
			<center>
                        [<a style="color: #f8851a;" href="login.html" target="_self">¿Ya tienes una cuenta?</a>]</center> 
          </section>
          <p>
            <?php
/*---------------------------variables-----------------*/           
...
/*----------------------------conexion-----------------*/                
                ...
                if($perf === "Alumno")
                $perf = 1;
                else if($perf === "Administrador")
                $perf = 2;
                else
                $perf = 3;
/*--------------------------insercion-----------------*/
              $sql = "INSERT INTO usuarios (usuario, pass, tipo) 
