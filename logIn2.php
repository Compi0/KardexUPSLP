...
if ($result->num_rows > 0) {
    ...
    echo "<input type='submit' name='boton' value=Cerrar Sesion>";
    echo "</form>";
    echo "<br>";
...
$row = $result->fetch_assoc();
 ...
 echo "No existen datos para ese usuarios";
    ...
    $sql2="SELECT id,matricula,semestre, materia, seccion, periodo, cfo, ext, reg, cf, creditos, status FROM kardex WHERE matricula='".$user."'";
    ...
    <td bgcolor='#B1B1B1'><font color=black>Creditos</td></font></tr>";
        ...
        while($row = $result2->fetch_assoc()) {
            ...
            echo"<td bgcolor='#DADADA'><font color=black>".$row['periodo']."</td>";
